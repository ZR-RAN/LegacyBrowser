...
public class BrowserContract {
    ...
    public static final String AUTHORITY = "com.example.browser";
    ...
    public static final class ChromeSyncColumns {
        ...
        public static final String SERVER_UNIQUE = BrowserContract.BaseSyncColumns.SYNC3;
        ...
        public static final String CLIENT_UNIQUE = BrowserContract.BaseSyncColumns.SYNC4;
    }
     ...
     * @hide
     */
    interface SyncColumns extends BrowserContract.BaseSyncColumns {
        /**
     ...
     */
    public static final class Bookmarks implements BrowserContract.CommonColumns, BrowserContract.ImageColumns, BrowserContract.SyncColumns {
        /**
        ...
        /**
         * Used in {@link BrowserContract.Bookmarks#TYPE} column and indicats the row is a bookmark.
         */
        public static final int BOOKMARK_TYPE_BOOKMARK = 1;

        /**
         * Used in {@link BrowserContract.Bookmarks#TYPE} column and indicats the row is a folder.
         */
        public static final int BOOKMARK_TYPE_FOLDER = 2;

        /**
         * Used in {@link BrowserContract.Bookmarks#TYPE} column and indicats the row is the bookmark bar folder.
         */
        public static final int BOOKMARK_TYPE_BOOKMARK_BAR_FOLDER = 3;

        /**
         * Used in {@link BrowserContract.Bookmarks#TYPE} column and indicats the row is other folder and
         */
        public static final int BOOKMARK_TYPE_OTHER_FOLDER = 4;

        /**
         * Used in {@link BrowserContract.Bookmarks#TYPE} column and indicats the row is other folder, .
         */
    ...
    public static final class Accounts {
        /**
         * Directory under {@link BrowserContract.Bookmarks#CONTENT_URI}
         */
         ...
         * returned when querying {@link BrowserContract.Bookmarks#CONTENT_URI_DEFAULT_FOLDER}.
         * <P>Type: INTEGER</P>
         */
     ...
     */
    public static final class History implements BrowserContract.CommonColumns, BrowserContract.HistoryColumns, BrowserContract.ImageColumns {
        /**
         * This utility class cannot be instantiated.
         */
        private History() {}
     ...
     * </p>
     */
    public static final class Images implements BrowserContract.ImageColumns {
        /**
         * This utility class cannot be instantiated
         */
        private Images() {}
        ...
        /**
         * Used in {@link BrowserContract.Images#TYPE} column and indicats the row is a favicon.
         */
        public static final int IMAGE_TYPE_FAVICON = 1;

        /**
         * Used in {@link BrowserContract.Images#TYPE} column and indicats the row is a precomposed touch icon.
         */
        public static final int IMAGE_TYPE_PRECOMPOSED_TOUCH_ICON = 2;

        /**
         * Used in {@link BrowserContract.Images#TYPE} column and indicats the row is a touch icon.
         */
     ...
     * </p>
     */
    public static final class ImageMappings implements BrowserContract.ImageMappingColumns {
        /**
         * This utility class cannot be instantiated
         */
     ...
     * @hide
     */
    public static final class Combined implements BrowserContract.CommonColumns, BrowserContract.HistoryColumns, BrowserContract.ImageColumns {
        /**
         * This utility class cannot be instantiated
         */
        private Combined() {}
