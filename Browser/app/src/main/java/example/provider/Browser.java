...
import example.provider.BrowserContract.Bookmarks;
import example.provider.BrowserContract.Combined;
import example.provider.BrowserContract.History;
import example.provider.BrowserContract.Searches;
...
public class Browser {
     ...
     * {@link example.provider.Browser.BookmarkColumns}.
     * @removed
     */
    public static final Uri BOOKMARKS_URI = Uri.parse("content://com.example.browser/bookmarks");
     ...
     * identifier.
     */
    public static final String EXTRA_APPLICATION_ID = "com.example.browser.application_id";
     ...
     * <p>
     */
    public static final String EXTRA_HEADERS = "com.example.browser.headers";

    /** @removed if you change column order you must also change indices below */
    public static final String[] HISTORY_PROJECTION = new String[] {
            Browser.BookmarkColumns._ID, // 0
            Browser.BookmarkColumns.URL, // 1
            Browser.BookmarkColumns.VISITS, // 2
            Browser.BookmarkColumns.DATE, // 3
            Browser.BookmarkColumns.BOOKMARK, // 4
            Browser.BookmarkColumns.TITLE, // 5
            Browser.BookmarkColumns.FAVICON, // 6
            Browser.BookmarkColumns.THUMBNAIL, // 7
            Browser.BookmarkColumns.TOUCH_ICON, // 8
            Browser.BookmarkColumns.USER_ENTERED, // 9
    };
     ...
     * {@link example.provider.Browser.SearchColumns}.
     * @removed
     */
    public static final Uri SEARCHES_URI = Uri.parse("content://com.example.browser/searches");

    /**
     * A projection of {@link #SEARCHES_URI} that contains {@link example.provider.Browser.SearchColumns#_ID},
     * {@link example.provider.Browser.SearchColumns#SEARCH}, and {@link example.provider.Browser.SearchColumns#DATE}.
     * @removed
     */
    public static final String[] SEARCHES_PROJECTION = new String[] {
            // if you change column order you must also change indices below
            Browser.SearchColumns._ID, // 0
            Browser.SearchColumns.SEARCH, // 1
            Browser.SearchColumns.DATE, // 2
    };
     ...
     *  column, {@link example.provider.Browser.BookmarkColumns#URL}.
     *
     ...
     *  have a single column, {@link example.provider.Browser.BookmarkColumns#URL}.
     *
     *  @param cr   The ContentResolver used to access the database.
     *  @removed
     */
    ...
    private static final void addOrUrlEquals(StringBuilder sb) {
        sb.append(" OR " + Browser.BookmarkColumns.URL + " = ");
    }
