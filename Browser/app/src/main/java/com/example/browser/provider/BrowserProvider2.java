...
package com.example.browser.provider;
...
import example.provider.Browser;
import example.provider.Browser.BookmarkColumns;
...
import com.example.browser.widget.BookmarkThumbnailWidgetProvider;
...
import example.provider.BrowserContract;
import example.provider.BrowserContract.Accounts;
import example.provider.BrowserContract.Bookmarks;
import example.provider.BrowserContract.ChromeSyncColumns;
import example.provider.BrowserContract.Combined;
import example.provider.BrowserContract.History;
import example.provider.BrowserContract.Images;
import example.provider.BrowserContract.Searches;
import example.provider.BrowserContract.Settings;
import example.provider.BrowserContract.SyncState;
